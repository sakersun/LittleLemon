    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                Text("First Name *").frame(maxWidth: .infinity, alignment: .leading).foregroundColor(.gray)
                TextField("First Name", text: $firstName)
                Text("Last Name *").frame(maxWidth: .infinity, alignment: .leading).foregroundColor(.gray)
